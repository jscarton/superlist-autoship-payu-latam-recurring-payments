                ...
                <div class="cont_central2 ">
                    <div class="row">
                        <div class="col-xs-4 col-sm-4 col-md-4">
                            <h4 class="titH">Atual 
                                <input type="radio" id="sim-dos" name='superlist-payu-use-this' value="<?php echo $existing->data->id;?>" checked>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <h4 style="color:#a1a3a5;">
                                ...
                                <input type="radio" id="nao-dos" name='superlist-payu-use-this' value="new">
                     ...
                     <div class="col-md-12 centPA">
                        ...
                        <div class="col-xs-2 col-sm-2 col-md-2">
                            ...
                            <input type="radio" class="irPA" name="superlist-payu-card-type" value="MASTERCARD" id="mastercard_payment_method">
                        ...
                        <div class="col-xs-2 col-sm-2 col-md-2">
                            ...
                            <input type="radio" class="irPA" name="superlist-payu-card-type" value="VISA" id="visa_payment_method">
                        ...
                        <div class="col-xs-2 col-sm-2 col-md-2">
                            ...
                            <input type="radio" class="irPA" name="superlist-payu-card-type" value="DINERS" id="diners_payment_method">
                        ...
                        <div class="col-xs-2 col-sm-2 col-md-2">
                            ...
                            <input type="radio" class="irPA" name="superlist-payu-card-type" value="ELO" id="elo_payment_method">
                        ...
                        <div class="col-xs-2 col-sm-2 col-md-2">
                            ...
                            <input type="radio" class="irPA" name="superlist-payu-card-type" value="AMEX" id="amex_payment_method">
					...
					<div class="col-md-12" style="display: inline-block;">
                        <div class="col-sm-6 col-md-6  col-lg-8">
                            ...
                            <div class="col-md-12" style="padding-left:0px!important;">
                                ...
                                <input type="hidden" name="superlist-payu-number" id="full-card-number">
                            </div>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-4" style="padding-left: 10px; display:inline-block;">
                            ...
                            <input type="text" class="sp-inputEP text-center sp-CC" name="superlist-payu-cvc" id="cc_ccv">
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6" style="display:inline-block;">
                            ...
                            <input type="text" class="sp-inputEP sp-CC" name="superlist-payu-card-name" id="superlist-payu-card-name">
                        </div>
                        <div class="col-sm-6 col-md-6 col-lg-6" style="display:inline-block !important; ">
                            ...
                            <input type="hidden" name="superlist-payu-expiry" id="validade-full">
                             <input type="hidden" name="superlist-payu-dni" value="<?php echo $current_user->billing_cpf; ?>">
                        </div>
